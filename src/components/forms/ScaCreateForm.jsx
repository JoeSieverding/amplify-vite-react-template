...
export default function ScaCreateForm(props) {
  ...
  const resetStateValues = () => {
    setPartner(initialValues.partner);
    setStart_date(initialValues.start_date);
    setEnd_date(initialValues.end_date);
    setContract_name(initialValues.contract_name);
    setContract_description(initialValues.contract_description);
    setContract_type(initialValues.contract_type);
    setContract_status(initialValues.contract_status);
    setContract_comments(initialValues.contract_comments);
    setContract_aws_contributions(initialValues.contract_aws_contributions);
    setContract_partner_contributions(
      initialValues.contract_partner_contributions
    );
    setContract_time_based_targets(initialValues.contract_time_based_targets);
    setContract_primary_industry(initialValues.contract_primary_industry);
    setContract_overall_status(initialValues.contract_overall_status);
    setContract_theme(initialValues.contract_theme);
    setErrors({});
  };
  const validations = {
    partner: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createSca.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "ScaCreateForm")}
      {...rest}
    >
      <TextField
        label="Partner"
